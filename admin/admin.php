...
class ATGB_Admin_Page {
    ...
    */
    public function __construct(){
        add_action( 'admin_menu', [ $this, 'atgb_plugin_admin_page' ] );
        add_action( 'admin_enqueue_scripts', [ $this, 'atgb_admin_page_assets' ] );
    }

    // Admin Assets
    public function atgb_admin_page_assets($screen) {
        if( 'tools_page_agt-teamblock' == $screen ) {
            wp_enqueue_style( 'admin-asset', plugins_url('assets/css/admin.css', __FILE__ ) );
        }
    }

    // Admin Page
    public function atgb_plugin_admin_page(){
        add_submenu_page( 'tools.php', 'Team Block', 'Team Block', 'manage_options', 'agt-teamblock', [ $this, 'atgb_admin_page_content_callback' ] );
    }
    public function atgb_admin_page_content_callback(){
        ?>
            <div class="admin_page_container">
                <div class="plugin_head">
                    <div class="head_container">
                        <h1 class="plugin_title"> Advanced Team Block </h1>
                        <h4 class="plugin_subtitle">A Custom Gutenberg Block to Showcase Team Members</h4>
                ...
                <div class="plugin_body">
                    <div class="doc_video_area">
                        <div class="doc_video">
                        <iframe width="100%" height="350" src="https://www.youtube.com/embed/O2jsbnLsy_Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
